...
CLogicalJoin *
CXformJoin2IndexApply::PopLogicalJoin(IMemoryPool *) const
{
	GPOS_RTL_ASSERT_MSG(false, "Should be overridden by child class");
	return NULL;
}

CLogicalApply *
CXformJoin2IndexApply::PopLogicalApply
	(
	IMemoryPool *, //pmp,
